...
//            .getRegistry()
            ...
            .authorizeRequests() //Allows restricting access based upon the HttpServletRequest using 
    	        ...
    	        .antMatchers("/admin/**").hasRole("ADMIN12") // “/admin/”开头的URL必须要是管理员用户，譬如”admin”用户
                .antMatchers("/hello/**").hasAuthority("ADMIN1") //使用hasRole("ADMIN12"),则对ADMIN12自动 加ROLE_前缀
    	        .anyRequest().authenticated() //所有URL请求都需要用户进行验证
                .and()
